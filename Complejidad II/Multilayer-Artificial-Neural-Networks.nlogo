...
to plot-predict
  ...
  [
    propagate
    plotxy (i + num-input-nodes)[activation] of first sort output-nodes
    move-window
    set i i + 1
  ]
end
...
to move-window
  ...
  set training-list lput ([activation] of first sort output-nodes) training-list
end
@#$#@#$#@
GRAPHICS-WINDOW
315
...
"" ""
PENS
"dat" 1.0 2 -16777216 true "" ""
"ANN-P" 1.0 0 -5298144 true "" ""
